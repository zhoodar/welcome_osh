	...
	<table align="center"  cellspacing="5" bgcolor="#ced7dd">
		...
		<tr   >
			<td>
			 ...
			 <a href="#"><strong>Кинотеатр  Акбуура </strong> </a> <br> <strong>Адрес:</strong> г.ОШ ул. Ленин 428 
			<br> <strong>Телефон:</strong> 0778205172, 0(3222) 7 09 73 
			<br> <strong>Часы работы:</strong> 10:00 - 21:45
		...
		<tr   >
			<td>
             <div style="padding: 5px; border-radius: 4px 4px 4px 4px; background-color: #FFFFFF;" >
			 <a href="#"><strong>Кинотеатр  Семетей</strong> </a> <br> <strong>Адрес:</strong> г.ОШ ул. Раззакова 
		...
		<tr   >
			<td>
             <div style="padding: 5px; border-radius: 4px 4px 4px 4px; background-color: #FFFFFF;" >
			 <a href="#"><strong>Кинотеатр  Marilyn Cinema</strong> </a> <br> <strong>Адрес:</strong> г.ОШ  ул.Ленина 320
		...
		<tr   >
			<td>
             <div style="padding: 5px; border-radius: 4px 4px 4px 4px; background-color: #FFFFFF;" >
			 <a href="#"><strong>Кинотеатр  ОРИОН ДВД </strong> </a> <br> <strong>Адрес:</strong> г.ОШ  улю Кыргызстан 78, эт.4 
			<br> <strong>Телефон:</strong>  (9963222)7-08-74, (9963222)7-70-31
			<br> <strong>Часы работы:</strong> 10:00-22:00
			<br> <a href="#"><strong>Фотографий </strong></a>| <a href="#"><strong>Отзывы</strong></a>
			</div>
			 </td>
