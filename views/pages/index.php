	 	 ...
	 	 <table id="news">
	  		  <tr> 
	  		     <td colspan="3" align="center"> <a href="#">
	  		          <strong> 02.03.2015 на ул. Монуева в ОШе произошло серьезное ДТП  </strong></a> 
	  		     </td>
	          </tr>
	  		  <tr>
				 <td width="60"></td>
				 ...
				 <td > <strong>02.03.2015 </strong>  <br />на ул. Раззакова в ОШе произошло серьезное ДТП с участием 5 машин </td>
	              ...
	              <td colspan="3" align="center"> <a href="#">
	                     <strong> ДТП  в 13 микрорайоне возле Лукойла. Автобус с ВАЗ-2107.  </strong></a> 
	              </td>
	          <tr >
				  <td width="60"></td>
	              ...
	              <td colspan="3" align="right"> <a href="#">
	                   <strong> <a href="#">Перейти к списку последных новестей &gt;&gt; </a>  </strong></a> 
	              </td>
		  </table>
	</div>
	<br />
