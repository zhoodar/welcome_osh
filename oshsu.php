...
<a href="index.php?view=index">Главная </a>&rarr;<a href="index.php?view=univers">ВУЗы</a> &rarr;
   <p> <h2>  Ошсйкий Государственный Университет. Отзывы, жалобы, контакты</h2> </p>
<hr noshade="0" size="15" color="#3e7aea" />
    <div>
		 <strong>Адрес:</strong> г.ОШ ул. Ленин 331
	...
	<table border="0">
	<tr height="150">
	<td><div style="padding: 2px;"><a rel="group" href="img/oshsu/1_big.jpg" ><img src="img/oshsu/1.jpg"/></a></div></td>
	<td><div style="padding: 2px;"><a rel="group" href="img/oshsu/2_big.jpg" ><img src="img/oshsu/2.jpg"/></a></div></td>
	<td><div style="padding: 2px;"><a rel="group" href="img/oshsu/3_big.jpg" ><img src="img/oshsu/3.jpg"/></a></div></td>
	<td><div style="padding: 2px;"><a rel="group" href="img/oshsu/4_big.jpg" ><img src="img/oshsu/4.jpg"/></a></div></td>
	</tr>
	<tr >
	<td><div style="padding: 2px;"><a rel="group" href="img/oshsu/5_big.jpg" ><img src="img/oshsu/5.jpg"/></a></div></td
	...
	<p >  <strong>Место нахождение на карте</strong> </p>
		<p align="center"><iframe align="middle" src="img/oshcity.png"  width="700" height="425"> </iframe></p>
	</div>
	
	<h3>Оставьте  свои отзывы</h3>
	<div>
	<?
	include("comments/oshsucomment.php");
	?>	
	</div>
