...
<a href="index.php?view=index">Главная </a>&rarr;<a href="index.php?view=guesthouse">Гостиницы</a> &rarr;
   <p> <h2> Гостиницы ОШ НУРУ Отзывы, жалобы, контакты</h2> </p>
<hr noshade="0" size="15" color="#3e7aea" />
    <div>
		 <strong>Адрес:</strong> г. Ош ул. Баялинова 1, 723500 
	...
	<table border="0">
	<tr height="160">
	<td><div style="padding: 2px;"><a rel="group" href="img/nuru/1_big.jpg" ><img src="img/nuru/1.jpg"/></a></div></td>
	<td><div style="padding: 2px;"><a rel="group" href="img/nuru/2_big.jpg" ><img src="img/nuru/2.jpg"/></a></div></td>
	<td><div style="padding: 2px;"><a rel="group" href="img/nuru/3_big.jpg" ><img src="img/nuru/3.jpg"/></a></div></td>
	<td><div style="padding: 2px;"><a rel="group" href="img/nuru/4_big.jpg" ><img src="img/nuru/4.jpg"/></a></div></td>
	</tr>
	<tr >
	<td><div style="padding: 2px;"><a rel="group" href="img/nuru/5_big.jpg" ><img src="img/nuru/5.jpg"/></a></div></td
	...
	<div ">
	<?
	include("comments/nurucoment.php");
	?>	
	</div>
