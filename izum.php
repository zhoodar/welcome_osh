...
<a href="index.php?view=index">Главная </a>&rarr;<a href="index.php?view=nightclub">Ночные клубы</a> &rarr;
   <p> <h2>  Кафе &amp; Бар Изюм. Отзывы, жалобы, контакты</h2> </p>
<hr noshade="0" size="15" color="#3e7aea" />
    <div>
		 <strong>Адрес:</strong> г.ОШ ул. Ленин 214 
			<br> <strong>Телефон:</strong> 03222 2 23 03 0551 119 119
			<br> <strong>Часы работы:</strong> ежедневно, 24 часа
		</div>
	...
	<table border="0">
	<tr height="150">
	<td><div style="padding: 2px;"><a rel="group" href="img/izum/1_big.jpg" ><img src="img/izum/1.jpg"/></a></div></td>
	<td><div style="padding: 2px;"><a rel="group" href="img/izum/2_big.jpg" ><img src="img/izum/2.jpg"/></a></div></td>
	<td><div style="padding: 2px;"><a rel="group" href="img/izum/3_big.jpg" ><img src="img/izum/3.jpg"/></a></div></td>
	<td><div style="padding: 2px;"><a rel="group" href="img/izum/4_big.jpg" ><img src="img/izum/4.jpg"/></a></div></td>
	</tr>
	</table>
	...
	<div ">
	<?
	include("comments/izumcomment.php");
	?>	
	</div>
